 ...
 * Generated for Laravel 4.2.16 on 2015-01-11.
 *
...
namespace {
    ...
    class Field extends \Innaco\Components\Field{
         ...
         * @static 
         */
        public static function getDefaultClass($type){
            return \Innaco\Components\FieldBuilder::getDefaultClass($type);
        }
         ...
         * @static 
         */
        public static function buildCssClasses($type, $attributes){
            return \Innaco\Components\FieldBuilder::buildCssClasses($type, $attributes);
        }
         ...
         * @static 
         */
        public static function buildLabel($name){
            return \Innaco\Components\FieldBuilder::buildLabel($name);
        }
         ...
         * @static 
         */
        public static function buildControl($type, $name, $value = null, $attributes = array(), $options = array()){
            return \Innaco\Components\FieldBuilder::buildControl($type, $name, $value, $attributes, $options);
        }
         ...
         * @static 
         */
        public static function buildError($name){
            return \Innaco\Components\FieldBuilder::buildError($name);
        }
         ...
         * @static 
         */
        public static function buildTemplate($type){
            return \Innaco\Components\FieldBuilder::buildTemplate($type);
        }
         ...
         * @static 
         */
        public static function input($type, $name, $value = null, $attributes = array(), $options = array()){
            return \Innaco\Components\FieldBuilder::input($type, $name, $value, $attributes, $options);
        }
        ...
        public static function password($name, $attributes = array()){
            return \Innaco\Components\FieldBuilder::password($name, $attributes);
        }
         ...
         * @static 
         */
        public static function select($name, $options, $value = null, $attributes = array()){
            return \Innaco\Components\FieldBuilder::select($name, $options, $value, $attributes);
        }
